...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.pretrained:
        ...
        if args.arch == 'alexnet':
            model = AlexNetCustom(num_classes=1000, dropout=0.5)
    ...
    # Data loading code
    traindir, train_anno = '/mnt/data/PETA_dataset', '/home/data/annotation.txt'
    # train_anno = '/home/face_attribute/data/fairface_label_train.csv'
    # valdir = '/home/face_attribute/data'
    # val_anno = '/home/face_attribute/data/fairface_label_val.csv'
    normalize = transforms.Normalize(mean=[0.485, 0.456, 0.406],
                                     std=[0.229, 0.224, 0.225])

    train_dataset = ColorAttribute(
        traindir,
        train_anno, 
        'train',
        transforms.Compose([
...
def validate(val_loader, model, criterion, args):
    ...
    with torch.no_grad():
        ...
        print(' * Acc@1 {top1.avg:.3f}'
              .format(top1=top1))
        with open('/mnt/color-classification/logs/log.txt', 'a') as f:
            f.write('Validate step, * Acc@1 {top1.avg:.3f}\n'.format(top1=top1))
...
def save_checkpoint(state, is_best, filename='checkpoint.pth.tar'):
    ...
    if is_best:
        shutil.copyfile(filename, 'model_glass_best.pth')
